...
namespace App4
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private const string IOT_HUB_CONN_STRING = "HostName=pragueiot.azure-devices.net;DeviceId=in4margaret;SharedAccessKey=AgcjhMldoqocP+52oi6+SZbA2SKgDnnM6jfkKP0tXZ8=";
        // Use the name of your Azure IoT device here - this should be the same as the name in the connections string
        private const string IOT_HUB_DEVICE = "in4margaret";
        // Provide a short description of the location of the device, such as 'Home Office' or 'Garage'
        private const string IOT_HUB_DEVICE_LOCATION = "Home";
        ...
        private const byte MCP3208_CONFIG = 0x68;
        private const byte MCP3008_CONFIG = 0x68;
